...
set_property IOSTANDARD LVCMOS18 [get_ports {led_status[12]}]
set_property PACKAGE_PIN N3 [get_ports {led_status[13]}]
set_property IOSTANDARD LVCMOS18 [get_ports {led_status[13]}]
set_property PACKAGE_PIN P1 [get_ports {led_status[14]}]
set_property IOSTANDARD LVCMOS18 [get_ports {led_status[14]}]
set_property PACKAGE_PIN L1 [get_ports {led_status[15]}]
set_property IOSTANDARD LVCMOS18 [get_ports {led_status[15]}]
