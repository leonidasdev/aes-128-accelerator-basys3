----------------------------------------------------------------------------------
-- Module Name:    tb_aes_adc_top
-- Project:        AES-128 Hardware Accelerator
-- Author:         PHR26-T03
-- Date:           15/05/2026
--
-- Description:
--   Integration testbench for adc_sampler_fsm and aes_top. Tests autonomous periodic
...
entity tb_aes_adc_top is
end entity tb_aes_adc_top;

architecture sim of tb_aes_adc_top is
...
begin
    ...
    begin
        ...
        report "[TEST] === SAMPLE 1: Waiting for first ADC sample (sim shortened) ===";
        ...
        report "[TEST] === SAMPLE 2: Waiting for second ADC sample (sim shortened) ===";
