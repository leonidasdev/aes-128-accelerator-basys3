...
architecture sim of tb_shift_rows is
...
begin
    ...
    begin
         report "==============================" & character'val(10) &
             "Starting ShiftRows testbench" & character'val(10) &
             "==============================" severity note;

        -- Test 1: Verify shift pattern with indexed bytes (0-15)
        test_num := test_num + 1;
        ...
        expected(15 downto 8)    := std_logic_vector(to_unsigned(5, 8));
        expected(23 downto 16)   := std_logic_vector(to_unsigned(10, 8));
        expected(31 downto 24)   := std_logic_vector(to_unsigned(15, 8));
        expected(39 downto 32)   := std_logic_vector(to_unsigned(4, 8));
        expected(47 downto 40)   := std_logic_vector(to_unsigned(9, 8));
        expected(55 downto 48)   := std_logic_vector(to_unsigned(14, 8));
        expected(63 downto 56)   := std_logic_vector(to_unsigned(3, 8));
        expected(71 downto 64)   := std_logic_vector(to_unsigned(8, 8));
        expected(79 downto 72)   := std_logic_vector(to_unsigned(13, 8));
        expected(87 downto 80)   := std_logic_vector(to_unsigned(2, 8));
        expected(95 downto 88)   := std_logic_vector(to_unsigned(7, 8));
        expected(103 downto 96)  := std_logic_vector(to_unsigned(12, 8));
        expected(111 downto 104) := std_logic_vector(to_unsigned(1, 8));
        expected(119 downto 112) := std_logic_vector(to_unsigned(6, 8));
        expected(127 downto 120) := std_logic_vector(to_unsigned(11, 8));
